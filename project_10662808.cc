/* OWUSU EMMANUEL
   ...
   C++ PROJECT WORK
            ...
            THIS PROGRAM IS BASICALLY DESIGNED FOR THE UNIVERSTIY OF GHANA-LEGON SCHOOL MANAGEMENT SYSTEM
*/            
...
{ public:
 ...
 staff t;
 student k;
 cout<<"WELCOME TO THE UNIVERSITY OF GHANA-LEGON SCHOOL MANAGEMENT SYSTEM.\n";
 system("pause");
 system("cls");
 while(p<=100)
     {     	
...
if(intro=="1")
 {   while(stdMenu<=10)
  ...
  cout<<"Please take note that You can't edit, delete or print the records of a student if you haven't";
  cout<<"\n entered any, choose option 1 to begin with.\n";
  cin>>stdIntro;
  if(stdIntro=="1")
    {while (z<=10)
        {
    system("cls");
    i++;
    cout<<"Please note that for easy accessibility the students data are been numbered\n";
    cout<<"For instance, the first student you'll create will be referred to as\n";
    cout<<"Student 1...the second will be Student 2...and soo on.\n";
    cout<<"Enter first name of student "<<i<< "\n";
    cin>>k.name[i-1];
    cout<<"Enter last name of student "<<i<< "\n";
    cin>>k.LName[i-1];
    cout<<"Enter date of birth of student "<<i<<" (in the format:dd/mm/yy)\n";
    cin>>k.dob[i-1];
    cout<<"Enter ID number of student "<<i<<"\n";
    cin>>k.ID[i-1];
    cout<<"Enter sex of student "<<i<<" (m or M for male, f or F for female)\n";
    cin>>k.sex[i-1];
    if((k.sex[i-1])=="m"||(k.sex[i-1])=="M")
        k.sex[i-1]="MALE";
    else if ((k.sex[i-1])=="f"||(k.sex[i-1])=="F")
        k.sex[i-1]="FEMALE";
    cout<<"How many courses will "<<k.name[i-1]<<" be reading this semester?(note that the maximum is 7)\n";
    cin>>cNo[i-1];
    ...
    if(addStd=='p')
     {   system("cls");
         cout<<"                                             STUDENT'S ACADEMIC RECORD                                                     \n";
...
cout<<"***********************************************************************************************************************\n";
    ...
    { while(x<=10)
          { system("cls");
           cout<<"Enter the Student's number( e.g.enter 1 for student 1 and so on....)\n";
    ...
    if((k.score[v][editS-1])>=80)
     ...
     (k.gpt[v][editS-1])=12; }
      ...
      cout<<"Data of "<<k.name[editS-1]<<" changed successfully\n";
      cout<<"Enter any key to go back\n";
      cin>>editS1L;
      system("cls");
      break;
          ...
          { system("cls");
           ...
           for(int d=0;d<cNo[del-1];d++)
             {k.courses[d][del-1]=" ";
              ...
              k.score[d][del-1]=0;
              k.gpa[d][del-1]=" ";
              cout<<"student's records deleted successfully, enter any key to go back\n";
              cin>>bk;
              break;
             }
             e++;
...
cout<<"***********************************************************************************************************************\n";	
    ...
    cout<<"Staff 1...second will be Staff 2...and soo on.\n";
